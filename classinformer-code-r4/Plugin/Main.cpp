...
bool idaapi run(size_t arg)
{
	try
	{
		...
		if (netNode)
		{
			...
			// Additional fix by: Rohitab Batra
...
udm_t createStrucMember(char* name, ea_t offset, asize_t nbytes, tinfo_t* type)
{
	udm_t udm{};
	...
	else
	{
		...
		{
		case 1:
			udm.type.create_simple_type(BT_INT8);
			break;
		case 2:
			udm.type.create_simple_type(BT_INT16);
			break;
		case 4:
			udm.type.create_simple_type(BT_INT32);
			break;
		case 8:
			udm.type.create_simple_type(BT_INT64);
			break;
		}
	}
